# =============================================================================
# File: cv_cnn_years_with_kaiming.py
# 說明：在 Skorch + GridSearchCV 中，針對 “play years” (球齡) 進行交叉驗證，
...
pd.DataFrame(gs.cv_results_).to_csv(
    'CVRecord/Years/SwingCNN_GroupKFold_Years_Kaiming.csv',
    index=True
)

print("=== Years CV with Kaiming 初始化 結果 ===")
