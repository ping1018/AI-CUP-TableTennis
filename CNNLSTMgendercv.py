# CNNLSTM_gender_scv.py
# 針對 gender (性別分類) 使用 CNN_LSTM 模型進行交叉驗證 (GroupKFold)
...
pd.DataFrame(gs.cv_results_).to_csv(
    'CVRecord/Gender/CNNLSTM_GroupKFold_Gender.csv', index=True
)

print("=== Gender CV with CNN-LSTM 結果 ===")
